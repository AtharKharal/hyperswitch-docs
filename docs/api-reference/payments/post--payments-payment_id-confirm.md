...
**Operation ID:** `Confirm a Payment`

## Playground

<a href="https://sandbox.hyperswitch.io/playground?endpoint=/payments/{payment_id}/confirm&method=POST" class="md-button-playground" target="_blank">Try in Playground →</a>
...
const url = "https://sandbox.hyperswitch.io/payments/{payment_id}/confirm";
const options = {
  method: "POST",
  url: url,
  headers: {"Content-Type": "application/json", "api-key": "YOUR_API_KEY"},
